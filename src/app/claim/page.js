...
export default function Claim() {
  ...
  const SkeletonTokenItem = () => (
    <div className="bg-[#1E1F26] rounded-lg px-4 py-4 border border-gray-700 flex items-center justify-between relative">
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                <div className='flex justify-center gap-2'>
                  <button
                    onClick={() => {
                      window.open(`https://pump.fun/profile${token.wallet_public_key}`, "_blank");
                    }}
